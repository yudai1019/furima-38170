class OrderAddress
 ...
 attr_accessor :municipality,:addressnum,:buildingname,:phonenum,:order_id,:user_id,:item_id,:area_id, :postnum
 
 
 validates :postnum, presence: true
 validates :municipality,presence: true
 validates :addressnum,presence: true,numericality: {with:/\A[0-9]{3}-[0-9]{4}\z/}
